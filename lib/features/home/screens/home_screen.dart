...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    _searchController.addListener(() {
      setState(() {}); // Memicu rebuild agar suffixIcon berubah
    });
  }
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            // Tampilkan hasil jika pencarian dilakukan
            if (hasSearched)
  ...
  // _buildPromoCarousel, _buildCategoryIcons, _buildSection tetap sama
}
